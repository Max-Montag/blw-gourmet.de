...
export default async function LandingPage() {
  ...
  return (
    <div className={`max-w-7xl 2xl:max-w-screen-2xl py-6 ${lato.className}`}>
      <Image
        src="/bg.webp"
        alt=""
        fill={true}
      ...
      <section className="w-full min-h-screen -mt-[var(--header-height)] py-[var(--header-height)] flex justify-center items-center">
        <div className="w-full min-h-fit py-4 flex flex-wrap justify-center items-center">
          <div className="mx-8 px-4 w-10/12 lg:w-7/12 text-center lg:text-start">
            <h1 className="animated-gradient py-4 font-bold xxs:font-black text-5xl xs:text-6xl lg:text-7xl xl:text-8xl text-transparent">
              Leckere Rezepte für euer Baby-led Weaning Abenteuer
            </h1>
            <p className="xxs:mx-6 sm:mx-16 lg:mx-0 lg:w-8/12 mt-2 xxs:mt-6 py-4 px-8 text-cyan-950 bg-cyan-50 bg-opacity-60 backdrop-blur-sm rounded-full lg:rounded-l-none font-bold text-xl md:text-2xl lg:text-3xl">
          ...
          <div className="w-full md:w-7/12 lg:w-4/12 my-4 xs:px-16 md:px-0 ">
            ...
            <div className="w-full py-4 flex justify-center items-center group">
              ...
              >
                <FaArrowDown className="mr-3 animate-bounce w-6 h-6" />
      ...
      <section className="w-full flex flex-col justify-center pb-8 px-8 lg:px-16">
