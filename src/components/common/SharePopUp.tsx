...
const SharePopUp: React.FC<SharePopUpProps> = ({
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed w-full h-screen top-0 left-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          {" "}
          <div className="relative w-9/12 sm:w-5/12 md:w-1/3 bg-white p-6 rounded-lg shadow-lg">
            <button
